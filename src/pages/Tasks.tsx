...
export default function Tasks() {
  ...
  return (
    <div>
      ...
      <div className="name-pills" style={{ marginBottom: 18 }}>
        {tasksAtlas.index.map((t, i) => (
          <a key={i} href={`#tp${t.page}`}>{t.name}</a>
        ))}
      </div>
      ...
      <Image.PreviewGroup>
        <div className="atlas-grid">
          {tasksAtlas.pages.map((pg) => (
            <div className="atlas-card" key={pg.page} id={`tp${pg.page}`} style={{ scrollMarginTop: 80 }}>
